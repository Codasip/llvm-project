...
; the two tests to produce the same output.
...
define i32 @simple_arith(i32 %a, i32 %b) nounwind #0 {
...
define i32 @select(i32 %a, i32 *%b) nounwind #0 {
; RV32IC-LABEL: select:
; RV32IC:         c.lw a2, 0(a1)
...
define i32 @pos_tiny() nounwind #0 {
...
define i32 @pos_i32_half_compressible() nounwind #0 {
...
define i32 @neg_tiny() nounwind #0 {
...
define i32 @pos_i32_hi20_only() nounwind #0 {
...
define i32 @neg_i32_hi20_only() nounwind #0 {
